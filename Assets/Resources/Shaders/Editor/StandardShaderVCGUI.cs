...
namespace UnityEditor
{
  public class StandardShaderVCGUI : ShaderGUI
  {
    ...
    private static class Styles
    {
      ...
      public static GUIContent vcLabel2 = new GUIContent("Vertex Emission", "Emission Intensity");
}
    ...
    MaterialProperty vertexEmission = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
      ...
      vertexEmission = FindProperty("_EmissionVC", props);
}
    ...
    public void ShaderPropertiesGUI(Material material)
    {
      ...
      EditorGUI.BeginChangeCheck();
      {
        ...
        m_MaterialEditor.ShaderProperty(vertexEmission, "Vertex Emission");
